...
class AdvertisementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create advertisement' do
    assert_difference('Advertisement.count') do
      post advertisements_url, params: { advertisement: { duration: @advertisement.duration, name: @advertisement.name, package: @advertisement.package } }
    end
  ...
  test 'should update advertisement' do
    patch advertisement_url(@advertisement), params: { advertisement: { duration: @advertisement.duration, name: @advertisement.name, package: @advertisement.package } }

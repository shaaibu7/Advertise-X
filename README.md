...
# 📖 [AdvertiseX] <a name="about-project"></a>


**[AdvertiseX]** this is an application that users can sign up and upload content for advertisement, there is also an admin that manages the platform.
